...
const routes: Routes = [
  ...
  { path: 'subject-group', component: SubjectGroupComponent, canActivate: [AuthGuard] },
  ...
  { path: 'structure/:id/:title', component: ReportStructureComponent, canActivate: [AuthGuard] },
  { path: 'transfer', component: TransferComponent, canActivate: [AuthGuard] },
  { path: 'transfers', component: TransfersComponent, canActivate: [AuthGuard] },
  { path: 'subject-institution', component: SubjectInstitutionComponent, canActivate: [AuthGuard] },
  { path: 'student-adding', component: StudentAddingComponent, canActivate: [AuthGuard] },
  { path: 'teacher-adding', component: TeacherAddingComponent, canActivate: [AuthGuard] },
  { path: 'report-transfer', component: ReportTransferComponent, canActivate: [AuthGuard] },
  { path: 'adding', component: AddingComponent, canActivate: [AuthGuard] },
  { path: 'addings', component: AddingsComponent, canActivate: [AuthGuard] },
  { path: 'adding/:id/:title', component: ReportAddingComponent, canActivate: [AuthGuard] },
  { path: 'report-transfers', component: ReportTransfersComponent, canActivate: [AuthGuard] },
  { path: 'report-transfer-sec', component: ReportTransferSecComponent, canActivate: [AuthGuard] },
  { path: 'listname-transfer/:id/:title', component: ListnameTransferComponent, canActivate: [AuthGuard] },
